...
public class Contact {
    ...
    public static List<Contact> getEnglishContacts() {
        ...
        contacts.add(new Contact("G", "Gol"));
        contacts.add(new Contact("G", "Goo"));
        contacts.add(new Contact("G", "GavV"));
        contacts.add(new Contact("H", "Hell"));
        contacts.add(new Contact("I", "Ivy"));
        contacts.add(new Contact("I", "IvyI"));
        ...
        contacts.add(new Contact("M", "Mix"));
        contacts.add(new Contact("N", "Nova"));
        contacts.add(new Contact("O", "Oni"));
        contacts.add(new Contact("P", "Paul"));
        contacts.add(new Contact("P", "Peter"));
        contacts.add(new Contact("Q", "Queue"));
        contacts.add(new Contact("R", "Ruby"));
